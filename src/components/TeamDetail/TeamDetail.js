...
const TeamDetail = () => {
    ...
    const {strStadiumThumb,strTeam,strSport,strDescriptionEN,strTeamBanner, strTeamFanart1,strTeamLogo,strTeamBadge,strGender,strLeague, strCountry,strAlternate, idTeam} = TeamDetail;
